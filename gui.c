...
u32 menu(u16 *original_screen)
{
  ...
  menu_option_type main_options[] =
  {
    ...
    submenu_option(&cheats_misc_menu, "Cheats and Miscellaneous options",
     ...
     "speed.", 9),
    action_option(menu_load, NULL, "Load game",
    ...
    action_option(menu_exit, NULL, "Resume game",
     "Select to exit this menu and resume gameplay.", 13),
    action_option(menu_quit, NULL, "Exit gpSP Emulator",
  ...
  if(gamepak_filename[0] == 0)
  {
    ...
    print_string_ext("Please load a game.", 0xFFFF, 0x0000,
